import { getRefundPolicy } from '@/lib/services/operations/PolicyApi';
    ...
    if (!policy || !policy.content) {
        return (
            <div className="max-w-[1200px] mx-auto px-6 py-24 text-left">
                <h1 className="text-3xl font-bold text-slate-800 tracking-tighter">Refund Policy Temporarily Unavailable</h1>
